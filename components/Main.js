        ...
        <div className={style.wrappermain}>
            ...
            <div className={style.biowrapper}>
                ...
                <div className={style.biotext}>
                    ...
                    <p>
                        ...
                        You can navigate only from homepage to collections: hats, shoes, ID dynamic route for each hats and shoes, authentication page, other route pages, checkout page, wishlist page only for functionalities and viewing (payment unauthorized).
            ...
            <div className={style.introwrap}>
                ...
                <div className={style.introcontainer}>
                    ...
                    <p> with strong analytical thinking and problem solving.</p>
                </div>
            </div>
