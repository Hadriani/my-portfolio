            ...
            <div className={style.biowrapper}>
                ...
                <div className={style.biotext}>
                    ...
                    <p>
                        ...
                        You can navigate only from homepage to collections: hats, shoes, ID dynamic route for each hat and shoe, authentication page, other route pages, checkout page, wishlist page only for functionalities and viewing (payment unauthorized).
